          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Photorealistic</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Ultra-high resolution rendering with lifelike skin textures and natural lighting
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Ultra-low latency interactions with smooth, fluid animations at 60fps
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Real-time emotional intelligence with <span className="text-[#FC4D0A]">perfect facial expressions</span>
                  </h3>
                </div>
              </div>
            </div>
